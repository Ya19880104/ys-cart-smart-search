...
$attackCases = [
    ...
    '; DROP TABLE wp_users',
    '); DROP TABLE wp_users',
    'abc); DROP TABLE wp_users',
    'abc)/**/;/**/DROP TABLE wp_users',
    'abc%29%3B%20DROP%20TABLE%20wp_users',
    'abc; DROP TABLE wp_users',
    'coat; DELETE FROM wp_users',
    'abc; SELECT user_pass FROM wp_users',
    'abc; SELECT 1',
    'abc%3B%20SELECT%201',
    'abc; SELECT 1 AS x',
    'abc%3B%20SELECT%201%2C%202',
    'abc;/**/SELECT/**/VERSION()/**/AS/**/v',
    'abc; INSERT wp_users VALUES (1)',
    'abc;/**/INSERT/**/wp_users/**/VALUES/**/(1)',
    'abc; DELETE LOW_PRIORITY FROM wp_users',
    'abc;/**/DELETE/**/LOW_PRIORITY/**/FROM/**/wp_users',
    'abc; UPDATE LOW_PRIORITY wp_users SET x=1',
    'abc;/**/UPDATE/**/IGNORE/**/wp_users/**/SET/**/x=1',
    'abc; DROP TEMPORARY TABLE wp_tmp',
    'abc%3B%20DROP%20TEMPORARY%20TABLE%20wp_tmp',
    'abc%3B%20DROP%20TABLE%20wp_users',
